...
impl BiosParameterBlock {
    ...
    fn calculate_sectors_per_fat(&self, partition: &Partition) -> u16 {
        ...
        let tmpval1: u32 = partition.sector_count
            - (u32::from(self.get_reserved_sectors()) + u32::from(rootdir_sectors));
        let tmpval2: u32 = (256 * u32::from(self.get_sectors_per_cluster()))
            + u32::from(self.get_number_of_fats());
